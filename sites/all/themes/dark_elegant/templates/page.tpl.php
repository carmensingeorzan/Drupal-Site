    ...
    <div id="main" class="clearfix">
        <?php if ($is_front): ?>
            <?php if (theme_get_setting('slideshow_display', 'dark_elegant')): ?>
                <?php
                $slide1_head = check_plain(theme_get_setting('slide1_head', 'dark_elegant'));
                $slide1_desc = check_markup(theme_get_setting('slide1_desc', 'dark_elegant'), 'full_html');
                $slide1_url = check_plain(theme_get_setting('slide1_url', 'dark_elegant'));
                $slide2_head = check_plain(theme_get_setting('slide2_head', 'dark_elegant'));
                $slide2_desc = check_markup(theme_get_setting('slide2_desc', 'dark_elegant'), 'full_html');
                $slide2_url = check_plain(theme_get_setting('slide2_url', 'dark_elegant'));
                $slide3_head = check_plain(theme_get_setting('slide3_head', 'dark_elegant'));
                $slide3_desc = check_markup(theme_get_setting('slide3_desc', 'dark_elegant'), 'full_html');
                $slide3_url = check_plain(theme_get_setting('slide3_url', 'dark_elegant'));
                $slide4_head = check_plain(theme_get_setting('slide4_head', 'dark_elegant'));
                $slide4_desc = check_markup(theme_get_setting('slide4_desc', 'dark_elegant'), 'full_html');
                $slide4_url = check_plain(theme_get_setting('slide4_url', 'dark_elegant'));
                $slide5_head = check_plain(theme_get_setting('slide5_head', 'dark_elegant'));
                $slide5_desc = check_markup(theme_get_setting('slide5_desc', 'dark_elegant'), 'full_html');
                $slide5_url = check_plain(theme_get_setting('slide5_url', 'dark_elegant'));
                ...
                <div id="slider">
                    <div class="flexslider">
                        <ul class="slides">
                            ...
                            <li><a href="<?php print url($slide4_url); ?>"><img class="slide-image" src="<?php print base_path() . drupal_get_path('theme', 'dark_elegant') . '/images/slide-image-4.jpg'; ?>"/></a>
                                <div class="flex-caption">
                                    <h3><?php print $slide4_head; ?></h3><?php print $slide4_desc; ?>
                                </div>
                            </li>
                            <li><a href="<?php print url($slide5_url); ?>"><img class="slide-image" src="<?php print base_path() . drupal_get_path('theme', 'dark_elegant') . '/images/slide-image-5.jpg'; ?>"/></a>
                                <div class="flex-caption">
                                    <h3><?php print $slide5_head; ?></h3><?php print $slide5_desc; ?>
                                </div>
                            </li>
                        </ul>
                    </div>  
        ...
        <?php if ($page['preface_first'] || $page['preface_middle'] || $page['preface_last']) : ?>
            ...
            if ($preface_count == 3) {
                $preface_grid = "grid_2";
            } elseif ($preface_count == 2) {
                $preface_grid = "grid_3";
            } elseif ($preface_count == 1) {
                $preface_grid = "grid_1";
            }
            ?>
